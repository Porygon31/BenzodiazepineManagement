...
{
    /// <summary>
    /// Formulaire pour ajouter une nouvelle ordonnance
    /// </summary>
    public partial class FormAddPrescription : Form
    {
        private DatabaseManager _databaseManager;
        private List<PrescriptionItem> _prescriptionItems = new List<PrescriptionItem>();

        public FormAddPrescription(DatabaseManager databaseManager)
        {
            InitializeComponent();
        ...
        private void FormAddPrescription_Load(object sender, EventArgs e)
        {
            ...
            dateTimePickerPrescription.Value = DateTime.Now;
        ...
        private void btnAddMedicament_Click(object sender, EventArgs e)
        {
            try
            {
                // Créer un nouvel élément de prescription
                ...
                // Si un benzodiazépine est sélectionné, l'associer
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                var prescription = new Prescription
                {
                    ...
                    DatePrescription = dateTimePickerPrescription.Value,
                    Observations = txtObservations.Text.Trim(),
                    Renouvelable = checkBoxRenouvelable.Checked,
                    NombreRenouvellements = checkBoxRenouvelable.Checked ? (int?)numericRenouvellements.Value : null,
                    Items = _prescriptionItems
                };

                _databaseManager.AddPrescription(prescription);

                MessageBox.Show("Ordonnance ajoutée avec succès.", "Succès",
