...
namespace BenzodiazepineManagement
{
    public partial class FormMain : Form
    {
        ...
        /// <summary>
        /// Charge les benzodiaz�pines depuis la base de donn�es et les affiche dans le DataGridView.
        /// </summary>
        ...
        /// <summary>
        /// �v�nement d�clench� lors du clic sur le bouton "Ajouter".
        /// </summary>
        ...
        /// <summary>
        /// Affiche les d�tails de la benzodiaz�pine s�lectionn�e dans les labels correspondants.
        /// </summary>
        /// <param name="benzo">La benzodiaz�pine � afficher.</param>
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            {
                var selectedBenzo = (Benzodiazepine)dataGridViewBenzos.CurrentRow.DataBoundItem;
                var result = MessageBox.Show($"�tes-vous s�r de vouloir supprimer {selectedBenzo.OfficialName} ?", "Confirmation", MessageBoxButtons.YesNo, MessageBoxIcon.Warning);
